...
csv_file = "commercial_2_signal_50Hz_outliers_zero_mean.csv"

timestamps = loadtxt('D:\\recording\\EEG_recording_2022-04-04-05.52.57.csv', delimiter=',', skiprows=1, usecols=(0))
print(timestamps.shape)
validTimestamps = timestamps[2290:,]

#=============================================================


tp9 = loadtxt('D:\\recording\\EEG_recording_2022-04-04-05.52.57.csv', delimiter=',', skiprows=1, usecols=(1))
print(tp9.shape)
tp9 = tp9[2290:,]
...
af7 = loadtxt('D:\\recording\\EEG_recording_2022-04-04-05.52.57.csv', delimiter=',', skiprows=1, usecols=(2))
print(af7.shape)
af7 = af7[2290:,]
b_notch, a_notch = signal.iirnotch(50, 30, 256)
...
af8 = loadtxt('D:\\recording\\EEG_recording_2022-04-04-05.52.57.csv', delimiter=',', skiprows=1, usecols=(3))
print(af8.shape)
af8 = af8[2290:,]
b_notch, a_notch = signal.iirnotch(50, 30, 256)
...
#fig = plt.figure(figsize =(10, 7))
#plt.boxplot(outputSignal)
too_high = outputSignal > 75.
outputSignal[too_high] = 75.
too_low = outputSignal < -100.
outputSignal[too_low] = -100.
outputSignalMedian = numpy.median(outputSignal)
...
tp10 = loadtxt('D:\\recording\\EEG_recording_2022-04-04-05.52.57.csv', delimiter=',', skiprows=1, usecols=(4))
print(tp10.shape)
tp10 = tp10[2290:,]
b_notch, a_notch = signal.iirnotch(50, 30, 256)
...
too_high = outputSignal > 50.
outputSignal[too_high] = 50.
too_low = outputSignal < -125.
outputSignal[too_low] = -125.
outputSignalMedian = numpy.median(outputSignal)
