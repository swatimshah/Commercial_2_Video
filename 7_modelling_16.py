...
my_epochs = loadtxt('D:\\recording\\total_epochs_20.csv', delimiter=',', skiprows=1)
...
# Create the model
model=Sequential()
model.add(Conv1D(filters=15, kernel_size=8, kernel_regularizer=L2(0.00007), bias_regularizer=L2(0.00007), activity_regularizer = L2(0.00007), kernel_constraint=min_max_norm(min_value=-0.007, max_value=0.007), padding='valid', activation='relu', strides=1, input_shape=(20, 1)))
model.add(Conv1D(filters=15, kernel_size=4, kernel_regularizer=L2(0.00007), bias_regularizer=L2(0.00007), activity_regularizer = L2(0.00007), kernel_constraint=min_max_norm(min_value=-0.007, max_value=0.007), padding='valid', activation='relu', strides=1))
model.add(Conv1D(filters=15, kernel_size=4, kernel_regularizer=L2(0.00007), bias_regularizer=L2(0.00007), activity_regularizer = L2(0.00007), kernel_constraint=min_max_norm(min_value=-0.007, max_value=0.007), padding='valid', activation='relu', strides=1))
model.add(Flatten())
...
# Compile the model   
adam = Adam(learning_rate=0.000004)
