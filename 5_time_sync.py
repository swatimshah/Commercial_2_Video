...
csv_file = "frame_eeg_commercial_2.csv"

frame_ts = loadtxt('D:\\recording\\commercial_2.csv', delimiter=',', skiprows=1)
print(frame_ts[:, 0].shape)

channels_ts = loadtxt('D:\\recording\\commercial_2_signal_50Hz_outliers_zero_mean.csv', delimiter=',', skiprows=1)
